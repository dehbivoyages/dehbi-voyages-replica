            ...
            >
              <div className="flex min-h-[38px] h-full items-center gap-1.5 px-2 py-0.5 sm:px-2.5">
                ...
                <button
                  ...
                  className="inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-full text-white/45 transition duration-200 ease-out hover:bg-white/10 hover:text-white/80 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#9ED68B] active:scale-[0.97]"
