...
const announcements: Announcement[] = [
  {
    ...
    title: 'Istanbul',
    price: '9.900 DHS',
    details: '7 nuits / 8 jours · Juil.–août 2026',
    fullTitle: 'Istanbul — Entre Orient et Occident',
    destination: 'International',
    description: 'Une parenthèse entre le Bosphore, les quartiers historiques et les plus beaux panoramas d’Istanbul.',
    highlights: ['Turkish Airlines ou RAM', 'Petit déjeuner inclus', 'Transferts inclus'],
  ...
  },
  {
    ...
    price: '14.500 DHS',
    details: '21 août–5 sept. 2026 · Saudia',
    fullTitle: 'Omra — Médine & La Mecque',
    ...
    highlights: ['Vol Saudia', 'Visas inclus', 'Bagage 23 kg + 23 kg'],
  ...
  },
  {
    ...
    title: 'Punta Cana',
    price: '15.000 DHS',
    details: '8 nuits / 10 jours · Été 2026',
    fullTitle: 'Punta Cana — Été 2026',
    destination: 'International',
