...
export default function TravelClock({ className = '' }: TravelClockProps) {
  ...
  return (
    <div className={`flex min-h-[56px] items-center gap-3 rounded-2xl border border-[#FF8C42]/30 bg-[#10213f] px-3.5 py-2.5 text-white shadow-md shadow-[#10213f]/15 ${className}`} aria-label="Heure actuelle au Maroc">
